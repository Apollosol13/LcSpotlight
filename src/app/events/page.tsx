    ...
    <main className="mx-auto w-full max-w-[1200px] flex-1 px-5 py-16 min-[601px]:px-10">
      ...
      <div className="grid gap-6 min-[601px]:grid-cols-2 min-[901px]:grid-cols-3">
        {(events ?? []).map((e) => (
          <div
            key={e.id}
            className="overflow-hidden rounded border border-[rgba(17,34,80,0.1)] bg-white transition-all hover:-translate-y-[3px] hover:shadow-[0_12px_40px_rgba(17,34,80,0.1)]"
          >
            <div
